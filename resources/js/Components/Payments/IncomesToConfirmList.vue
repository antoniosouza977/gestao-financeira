        ...
        <Accordion value="0">
            <AccordionPanel value="1">
                <AccordionHeader class="w-full" >
                    ...
                    Pagamento de Rendas Mensais não confirmadas
                    <Badge severity="warn">{{incomes.length}}</Badge>
                    </span>
                </AccordionHeader>
                <AccordionContent>
                    <div v-for="income in incomes" :key="income.id"
                        ...
                        <div class="xl:w-1/5 lg:w-1/3 w-1/2 flex flex-col justify-start flex-wrap gap-2 p-3 pl-0">
                            ...
                            <InputNumber fluid inputId="value" :min-fraction-digits="2" v-model="income.value"
                                         class="w-fit"
